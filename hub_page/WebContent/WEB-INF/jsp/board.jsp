...
<script>
	...
	/* function iframeopen(url){
			$.ajax({
				url:url, 
				success:function(){
					 $('.iframe').replaceWith("<div class='iframe' style='float: left; width: 60%;'>"+
...
<div class="iframe1"style="float: left; width: 40%;">
 ...
 <div class="iframe">
<!-- <div class="iframe" style="float: left; width: 60%;">
<iframe src="http://www.daum.net" style="display:block; width:100vw; height: 100vh">
</iframe>
--></div> 
</body>
