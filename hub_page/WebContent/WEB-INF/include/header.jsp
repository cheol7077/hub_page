		...
		<div id="header-wrapper">
			...
			<div id="header">
				...
				<ul>
					...
					<li><a href="left-sidebar.html">content1</a></li>
					<li><a href="right-sidebar.html">content1</a></li>
					<li><a href="no-sidebar.html">content1</a></li>
				</ul>
				</nav>

				<!-- Banner -->
				<section id="banner"> <header>
				<h2>ALL about the Community!</h2>
